...
const COL_TITLE := Color("f6ead0")
const COL_GOLD := Color("efbd62")
const COL_TOP := Color("f0edf4")
const COL_VERSION := Color("c9c5d0")
...
func _draw() -> void:
    ...
    _center_text(ui_font, "BIENVENIDO A", left, content_width, 145.0 * scale_factor, maxi(16, int(round(28.0 * scale_factor))), COL_TOP)
